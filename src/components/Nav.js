...
class Nav extends Component {
    render()  {
        return <div className="w-full bg-transparent absolute z-10">
            <div className="flex flex-col px-4 md:items-center md:justify-between md:flex-row md:px-6 lg:px-8 max-w-screen-xl mx-auto">
                <div className="p-4 flex flex-row items-center justify-between">
                    <a href="#" className="text-lg font-semibold tracking-widest text-gray-400 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">ATIII</a>
